...
// GET /api/portfolio/[accountNumber]/unrealizedgl — latest Cost Basis / Unrealized Gain-Loss per position.
export async function GET(
  ...
  const { importRow, rows } = await getLatestUnrealizedGainLoss(accountNumber)
