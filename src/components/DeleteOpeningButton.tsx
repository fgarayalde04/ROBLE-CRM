...
export default function DeleteOpeningButton({ openingId, folderName }: Props) {
  ...
  if (confirm) {
    return (
      <div className="flex items-center gap-1.5">
        <span className="text-[11px] text-gray-500 max-w-[100px] truncate" title={folderName}>¿Eliminar?</span>
        <button
